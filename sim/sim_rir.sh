...
#SBATCH --output=/home/jo378964/Dokumente/ma/bp-gbp/sim/output/bp4_rir/output.%x_%A_%a.txt

### beginning of executable commands
cd /home/jo378964/Dokumente/ma/bp-gbp/sim
source /home/jo378964/.zshrc
./sim_KL ./input/input_files/input_rir_${SLURM_ARRAY_TASK_ID}.json ./output/bp4_rir