...
#SBATCH --output=/home/jo378964/Dokumente/ma/bp-gbp/sim/output/surface_pp_thr/output.%x_%A_%a.txt

### beginning of executable commands
cd /home/jo378964/Dokumente/ma/bp-gbp/sim
source /home/jo378964/.zshrc
./sim_KL ./input/input_files/surface_pp/input_surface_pp_${SLURM_ARRAY_TASK_ID}.json ./output/surface_pp_thr