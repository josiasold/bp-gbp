...
#SBATCH --output=/home/jo378964/Dokumente/ma/bp-gbp/sim/output/surface_gbp/output.%x_%A_%a.txt

### beginning of executable commands
cd /home/jo378964/Dokumente/ma/bp-gbp/sim
# source /home/jo378964/.zshrc
module load gcc/6
srun sim_KL ./input/input_files/surface_gbp/input_surface_gbp_${SLURM_ARRAY_TASK_ID}.json ./output/surface_gbp