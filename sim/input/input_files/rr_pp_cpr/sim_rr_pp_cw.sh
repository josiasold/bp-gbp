...
#SBATCH --output=/home/jo378964/Dokumente/ma/bp-gbp/sim/output/bp4_rr_pp_cpr/output.%x_%A_%a.txt

### beginning of executable commands
cd /home/jo378964/Dokumente/ma/bp-gbp/sim
source /home/jo378964/.zshrc
./sim_KL ./input/input_files/rr_pp_cpr/input_rr_pp_cpr_${SLURM_ARRAY_TASK_ID}.json ./output/bp4_rr_pp_cpr
