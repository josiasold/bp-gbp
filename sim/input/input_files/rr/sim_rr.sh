...
#SBATCH --output=/home/jo378964/Dokumente/ma/bp-gbp/sim/output/rr_thr/output.%x_%A_%a.txt

### beginning of executable commands
cd /home/jo378964/Dokumente/ma/bp-gbp/sim
source /home/jo378964/.zshrc
./sim_KL ./input/input_files/rr/input_rr_${SLURM_ARRAY_TASK_ID}.json ./output/rr_thr
